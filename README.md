# Delphi-Books Web Site Builder

[Cette page en français.](LISEZMOI.md)

Builder program for [Delphi-Books.com](https://delphi-books.com) website.
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/DelphiBooks-WSBuilder).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/DelphiBooks-WSBuilder) and [open a new issue](https://github.com/DeveloppeurPascal/DelphiBooks-WSBuilder/issues).
